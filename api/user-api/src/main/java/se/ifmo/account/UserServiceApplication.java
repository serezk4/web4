 ...
 * annotation, which serves as a convenience annotation that combines {@code @Configuration}, {@code @EnableAutoConfiguration},
 * and {@code @ComponentScan} with default attributes.
 * <p>
 * The {@code scanBasePackages} parameter is used to specify the base package ("com.box.id") to scan for Spring components,
 * configuration classes, and services.
 * </p>
 * <p><b>Usage:</b></p>
 ...
 * @since 1.0
 */
@SpringBootApplication(scanBasePackages = "se.ifmo.account")
