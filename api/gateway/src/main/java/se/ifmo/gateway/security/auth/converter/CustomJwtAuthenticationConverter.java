package se.ifmo.gateway.security.auth.converter;

import se.ifmo.gateway.security.auth.model.CustomUserDetails;
import se.ifmo.gateway.security.auth.token.CustomJwtAuthenticationToken;
